...
func choiseСharСlass() string {
	...
	for approveСhoice != "y" {
		...
		fmt.Scanf("%s\n", &approveСhoice)
		approveСhoice = strings.ToLower(approveСhoice)
	}
	return charСlass
}
